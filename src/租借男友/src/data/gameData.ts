...
export const MAP_LOCATIONS = [
  ...
  },
  {
    category: "校内",
    name: "艺术楼琴房",
    desc: "艺术楼五楼，隔音琴房，三角钢琴与立式钢琴各数间，走廊常飘琴声。",
    chars: ["温知晚", "椎名律"]
  },
  {
    category: "校内",
    name: "艺术楼练功房",
    desc: "艺术楼三楼，整面镜墙与把杆，木地板，供舞蹈与形体训练使用。",
    chars: ["温知晚", "椎名律"]
  },
  {
    category: "校内",
  ...
  },
  {
    category: "校内",
    name: "食堂三楼",
    desc: "中部，咖啡厅形式，有沙发座，环境安静，校内约会备选地点。",
    chars: []
  },
  {
    category: "校内",
  ...
  },
  {
    category: "周边",
    name: "步玲燕摊位",
    desc: "南门小吃街中段，算命摆摊。红布铺桌，旧书《渊海子平》作装饰，收款码立于一旁。城管一来，1分47秒即可收摊跑路。",
    chars: ["步玲燕"]
  },
  {
    category: "周边",
